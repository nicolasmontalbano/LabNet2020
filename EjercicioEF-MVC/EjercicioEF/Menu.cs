            ...
            try
            {
                ...
                while (aux)
                {
                    Console.WriteLine("Ingrese una opcion: \n\n1)Consultar un producto por ID" +
                                                    ...
                                                    "\n5)ABM" +
                                                    "\n6)Consultar todas las categorias" +
                                                    "\n7)Salir");
                    ...
                    switch (n)
                    {
                        ...
                        case 5:
                            ...
                            switch (n2)
                            {
                                ...
                                case 7:
                                    ...
                                    nuevaCategoria.CategoryName = Console.ReadLine();
                                    Console.WriteLine("Ingrese la descripcion");
                                    nuevaCategoria.Description = Console.ReadLine();
                                    categoriesLogic.Insert(nuevaCategoria);
                                    break;
                        ...
                        case 6:
                            ...
                            {
                                Console.WriteLine($"\nID de categoria: {cat.CategoryID}," +
                                                  $"\nNombre de la categoria: {cat.CategoryName}" +
                                                  $"\nDescripcion de la categoria: {cat.Description}\n");
                            }
                            break;
                        case 7:
                            aux = false;
